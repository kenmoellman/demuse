...
char *log_chan_important = NULL;
char *log_chan_sensitive = NULL;
char *log_chan_error = NULL;
char *log_chan_io = NULL;
char *log_chan_gripe = NULL;
char *log_chan_force = NULL;
char *log_chan_prayer = NULL;
char *log_chan_combat = NULL;
char *log_chan_suspect = NULL;
