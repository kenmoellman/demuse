...
/* Version globals removed — version is now fully defined by BASE_VERSION
   in credits.h, auto-generated by the pre-commit hook. */
 ...
 * Version string is fully defined by BASE_VERSION in credits.h,
 * auto-generated by the pre-commit hook (scripts/update-version.sh).
...
void do_version(dbref player)
{
    ...
    notify(player, tprintf("   Version: %s", BASE_VERSION));
