...
extern void do_lockout (dbref, char *, char *);
extern void do_unlockout (dbref, char *, char *);
...
extern void send_message_text (struct descriptor_data *,char *,int);
...
extern int do_channel_search(dbref, const char *, dbref);
